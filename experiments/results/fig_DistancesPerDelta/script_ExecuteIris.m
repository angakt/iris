...
for jj=2:5
    ...
    switch jj
        case 2
            ...
            name = '14';
        case 3
            delta = 2^length_of_IdSpace/8;
            name = '18';
        case 4
            delta = 2^length_of_IdSpace/16;
            name = '116';
        case 5
            delta = 2^length_of_IdSpace/32;
            name = '132';
        otherwise
            disp('more loops than defined delta paramters')
    end
...
file_name = ['test_exp100_n1000_a035_d' name '_att00.mat'];
save(file_name)
...
keepvars = {'number_of_experiments','jj','number_of_nodes','length_of_IdSpace'};
clearvars('-except', keepvars{:});
