...
for jj=2:5
    ...
    switch jj
        ...
        case 5
            ...
            name = '075';
        otherwise
            disp('more loops than defined alpha paramters')
    end
...
keepvars = {'number_of_experiments','jj','name','targets','addresses_of_nodes','addresses_of_objects','random_points','dist_N2Op','dist_N2Ir','priv_data','ub_data'};
...
file_name = ['test_exp100_n1000_a' name '_d116_att00.mat'];
save(file_name)

dist_file_name = ['data_a' num2str(jj) '.csv'];
%% when using Octave
csvwrite(dist_file_name,dist_N2Op)
%% when using Matlab
% writematrix(dist_N2Op,dist_file_name)

keepvars = {'number_of_experiments','jj'};
clearvars('-except', keepvars{:});
